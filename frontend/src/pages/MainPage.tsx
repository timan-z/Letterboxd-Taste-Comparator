        ...
        <div id="mpWrapper" className="wrapper">
            ...
            <header id="pageTitle">
                <h1 className="headerEl">
                    <img style={{width:"50px"}} src="/assets/images/straub.png" alt="Picture of old-man Jean-Marie Straub" title="This was originally supposed to be the Letterboxd icon but after reviewing their TOS, might be best to avoid doing that! Instead here's a picture of grumpy old-man Jean-Marie Straub."/>
