        ...
        <div id="apWrapper" className="wrapper">
            ...
            <header id="pageTitle">
                <h1 className="headerEl">
                    <img style={{width:"50px"}} src="frontend/src/assets/images/eustache.png" alt="Picture of Jean Eustache" title="This was originally supposed to be the Letterboxd icon but after reviewing their TOS, might be best to avoid doing that! Instead here's a picture of Jean Eustache when he was (presumably) happy in life."/>
